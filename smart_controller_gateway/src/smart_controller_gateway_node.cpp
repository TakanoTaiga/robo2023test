...
namespace smart_controller_gateway
{
    ...
    {   
        ...
        pub_gamepad_ = create_publisher<remote_control_msgs::msg::Gamepad>("smart_controller_gateway/output/gamepad", 1);
        pub_smart_ui_ = create_publisher<remote_control_msgs::msg::SmartUI>("smart_controller_gateway/output/smartui", 1);
        pub_twist_ = create_publisher<geometry_msgs::msg::Twist>("smart_controller_gateway/output/twist" , 1);
